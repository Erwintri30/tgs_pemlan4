...
public class pekerja extends manusia {
    ...
    public pekerja(double gaji, int tahun, int bulan, int tanggal, int jumlahAnak, String nama, String nik,
    ...
    public double hitungTotalBonus() {
        return getBonus();
    }

    public double getPendapatan() {
        return super.getPendapatan() + getGaji() + hitungTotalBonus();
    }
